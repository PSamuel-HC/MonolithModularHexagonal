...
static async Task Demo_CancelOrderById(int orderId)
{
    Console.WriteLine($"\n── German: Cancel Order n: {orderId} ───");
    ...
    Console.WriteLine($"{updated} orders were/was cancelled.");
    ...
    Console.WriteLine($"{deleted} order item(s) removed from order items.");
}
